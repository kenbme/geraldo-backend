...
export class EstablishmentController {
  ...
  async updateEstablishment(
    ...
    const establishment = await this.establishmentService.updateEstablishment(
      userId,
  ...
  async getEstablishmentsOrderedByPrice(
    ...
    const establishments = await this.establishmentService.getEstablishmentsOrderedByPrice(
      query.latitude,
      query.longitude,
      query.fuelType
    )
