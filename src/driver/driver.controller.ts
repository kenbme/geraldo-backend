...
import { DriverResponseDTO } from './dto/response/driver.response.dto'
...
export class DriverController {
  ...
  async create(@Body() createDriverDto: CreateDriverDto): Promise<{ data: DriverResponseDTO; message: string }> {
